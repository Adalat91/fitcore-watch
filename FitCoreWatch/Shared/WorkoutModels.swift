...
extension WorkoutTemplate {
    static let quickStartTemplates = [
        WorkoutTemplate(
            name: "Quick Push",
            exercises: [
                ...
                Exercise(name: "Pike Push-ups", category: "Shoulders", sets: [
                    Set(weight: nil, reps: 10),
        ...
        WorkoutTemplate(
            ...
            exercises: [
                ...
                Exercise(name: "Inverted Rows", category: "Back", sets: [
                    Set(weight: nil, reps: 12),
                    Set(weight: nil, reps: 10),
                    Set(weight: nil, reps: 8)
                ])
        ...
        WorkoutTemplate(
            name: "Quick Legs",
            exercises: [
                Exercise(name: "Squats", category: "Legs", sets: [
                    Set(weight: nil, reps: 20),
                    Set(weight: nil, reps: 15),
                    Set(weight: nil, reps: 12)
                ]),
                Exercise(name: "Lunges", category: "Legs", sets: [
                    Set(weight: nil, reps: 12),
                    Set(weight: nil, reps: 10),
                    Set(weight: nil, reps: 8)
                ])
